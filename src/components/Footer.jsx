...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="relative bg-slate-950/20 pt-16 pb-12 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div className="border border-slate-800 bg-slate-950/80 rounded-3xl p-8 sm:p-12 shadow-2xl relative">
          {/* Subtle design element: corner gradients inside the frame */}
          <div className="absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-cyan-500/30 via-indigo-500/30 to-purple-600/30 rounded-t-3xl" />
          
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 pb-12 border-b border-slate-900">
              ...
              <div className="space-y-4">
                <div className="inline-block overflow-hidden p-2">
                  <img 
                    src="/logo.png" 
                    alt="Mobiweb Logo" 
                    className="h-28 w-auto max-w-[240px] object-contain block scale-[1.3] origin-center" 
                  />
                </div>
